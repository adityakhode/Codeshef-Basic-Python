...
#_____________________________________________________________________________________________________________________________________________________________________________________________________________________	
	...
	def __init__(self):
		...
		self.Kp = [5.88   , 5.88   , 5.22 ] 
		self.Ki = [0.0008 , 0.0008 , 0.008]
		self.Kd = [26.1   , 26.1   , 171  ]
	...
	def roll_pid(self):
		...
		self.sum_error[0] +=self.error[0]               #slider values of kp,ki,kd is (98,1,87)
	...
	def throttle_pid(self):
		self.error[2] = -(self.setpoint[2]- self.drone_position[2])
		self.cmd.rcThrottle = int(1587+ self.error[2] * self.Kp[2] + ((self.error[2] - self.prev_error[2])) * self.Kd[2] + self.sum_error[2]* self.Ki[2])
